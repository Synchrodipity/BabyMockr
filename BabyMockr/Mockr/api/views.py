...
class BabyNameDetail(generics.RetrieveUpdateDestroyAPIView):
    queryset = BabyName.objects.all()
    serializer_class = BabyNameSerializer

# class ListNestedBabyNames(generics.ListCreateAPIView):
#     queryset = BabyName.objects.all()
#     serializer_class = NestedBabyNameSerializer
